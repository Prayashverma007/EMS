<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="Manage-Location-Add.aspx.cs" Inherits="Manage_Location_Add" %>
...
<asp:Content ID="cMainContent" runat="server" ContentPlaceHolderID="cphMain">
    <div class="title">Add/Edit Location Details<br /><br /></div>
